$(function () {
    ...
    const infoUrl = '/o2o/shopadmin/getproductbyid?productId=' + productId;
    // 获取当前店铺设定的商品类别列表的URL
    const categoryUrl = '/o2o/shopadmin/getproductcategorylist';
    // 更新商品信息的URL
    ...
    function getCategory() {
        $.getJSON(categoryUrl, function (data) {
            if (data.success) {
                var productCategoryList = data.dataList;
                var optionHtml = '';
